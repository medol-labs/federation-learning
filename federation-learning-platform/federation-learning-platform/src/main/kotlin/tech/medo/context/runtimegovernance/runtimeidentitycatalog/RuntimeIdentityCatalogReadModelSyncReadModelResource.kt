...
@CrossOrigin
@RestController
@RequestMapping("/sync/read-models/runtime-provisioning/runtime-identity-catalog")
class RuntimeIdentityCatalogReadModelSyncReadModelResource(
