...
@Service
class RuntimeTelemetryLatestReadModelQueryService(
    private val repository: SpringDataRuntimeTelemetryLatestReadModelRepository
) : QueryService<RuntimeTelemetryLatestReadModelEntity>() {
    fun findByCriteria(criteria: RuntimeTelemetryLatestReadModelCriteria?, pageable: Pageable): Page<RuntimeTelemetryLatestReadModel> =
    ...
    private fun buildLocalDateTimeRangeSpecification(
        filter: RangeFilter<*>,
        field: Function<Root<RuntimeTelemetryLatestReadModelEntity>, Expression<LocalDateTime>>
    ): Specification<RuntimeTelemetryLatestReadModelEntity> =
    ...
    private fun <X : Comparable<in X>> buildExpressionRangeSpecification(
        ...
        field: Function<Root<RuntimeTelemetryLatestReadModelEntity>, Expression<X>>
    ): Specification<RuntimeTelemetryLatestReadModelEntity> =
        Specification { root, _, builder ->
            val expression = field.apply(root)
            val predicates = mutableListOf<jakarta.persistence.criteria.Predicate>()
