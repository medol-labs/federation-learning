...
```bash
cd ..
node scripts/build-images.mjs --module federation-learning-support
```
...
```bash
cd ..
node scripts/export-images.mjs --module federation-learning-support
```
...
```bash
node scripts/import-images.mjs --file federation-learning-support-images.tar
...
```bash
cd ..
node scripts/image-bundle.mjs all --module federation-learning-support
```
...
```bash
cd ..
./mvnw -pl federation-learning-support -am -DskipTests clean install
