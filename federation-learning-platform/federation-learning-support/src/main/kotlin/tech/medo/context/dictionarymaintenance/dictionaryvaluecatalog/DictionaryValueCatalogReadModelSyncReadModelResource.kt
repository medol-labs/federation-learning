...
@CrossOrigin
@RestController
@RequestMapping("/sync/read-models/dictionary-maintenance/dictionary-value-catalog")
class DictionaryValueCatalogReadModelSyncReadModelResource(
    ...
    fun findAllForSync(
        ...
        val highWatermark = outboxRepository
            .findFirstBySourceContextAndSourceReadModelOrderBySequenceDesc("DictionaryMaintenance", "DictionaryValueCatalog")
            ?.sequence ?: 0
