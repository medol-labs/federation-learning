...
class ReportAgentDatasetMetadataToPlatformProcessorTest {
    ...
    fun reportsAgentDatasetMetadataToPlatform() {
        ...
        assertEquals(runtimeDatasetBindingId, request.runtimeDatasetBindingId)
        ...
        assertEquals("Test Organization", request.organizationName)
        ...
        assertEquals("credit-risk", request.featureDomain)
        assertEquals("v1", request.featureSchemaVersion)
