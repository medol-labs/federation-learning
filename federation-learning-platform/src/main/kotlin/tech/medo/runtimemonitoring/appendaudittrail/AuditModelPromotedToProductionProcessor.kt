...
@Component
class AuditModelPromotedToProductionProcessor(private val commandGateway: CommandGateway) {
    @EventHandler
    fun on(event: ModelPromotedToProductionEvent): java.util.concurrent.CompletableFuture<AppendAuditTrailCommand> =
