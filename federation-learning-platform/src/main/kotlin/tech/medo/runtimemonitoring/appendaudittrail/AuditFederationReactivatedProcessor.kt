...
@Component
class AuditFederationReactivatedProcessor(private val commandGateway: CommandGateway) {
    @EventHandler
    fun on(event: FederationReactivatedEvent): java.util.concurrent.CompletableFuture<AppendAuditTrailCommand> =
