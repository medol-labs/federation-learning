...
class TrainingRoundState @EntityCreator constructor() {
    ...
    private var selectedOrganizationIds: List<UUID> = emptyList()
    private var selectedRuntimeIds: List<UUID> = emptyList()
    private var selectedParticipants: List<TrainingRoundParticipant> = emptyList()
    private var selectedOrganizationCount: Int? = null
    private var selectedRuntimeCount: Int? = null
    ...
    private var anomalyScore: BigDecimal? = null
    private var rejectionReason: String? = null
    private var acceptedModelUpdateCount: Int? = null
    ...
    private var globalAccuracy: BigDecimal? = null
    private var globalFairnessScore: BigDecimal? = null
