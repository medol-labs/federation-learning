...
@Primary
@Component
class SelectTrainingRoundParticipantsServiceRouter(
    private val adapters: ObjectProvider<SelectTrainingRoundParticipantsService>
    ...
    override fun execute(input: SelectTrainingRoundParticipantsInput): SelectTrainingRoundParticipantsResult {
        ...
        return when (candidates.size) {
            1 -> candidates.first().execute(input)
