...
class SecureAggregationSessionCatalogReadModelQueryService(
    ...
    private fun createSpecification(criteria: SecureAggregationSessionCatalogReadModelCriteria?): Specification<SecureAggregationSessionCatalogReadModelEntity> {
        ...
        if (criteria != null) {
            ...
            criteria.roundNumber?.let { specification = specification.and(buildExpressionRangeSpecification(it, Function<Root<SecureAggregationSessionCatalogReadModelEntity>, Expression<Int>> { root -> root.get("roundNumber") })) }
            ...
            criteria.selectedOrganizationCount?.let { specification = specification.and(buildExpressionRangeSpecification(it, Function<Root<SecureAggregationSessionCatalogReadModelEntity>, Expression<Int>> { root -> root.get("selectedOrganizationCount") })) }
            criteria.selectedRuntimeCount?.let { specification = specification.and(buildExpressionRangeSpecification(it, Function<Root<SecureAggregationSessionCatalogReadModelEntity>, Expression<Int>> { root -> root.get("selectedRuntimeCount") })) }
            ...
            criteria.publicKeyRef?.let { specification = specification.and(buildSpecification(it, Function<Root<SecureAggregationSessionCatalogReadModelEntity>, Expression<String>> { root -> root.get("publicKeyRef") })) }
    ...
    private fun SecureAggregationSessionCatalogReadModelEntity.toProjection(): SecureAggregationSessionCatalogReadModelProjection =
        SecureAggregationSessionCatalogReadModelProjection().also {
            ...
            it.publicKeyRef = this@toProjection.publicKeyRef
