...
@Service
class RuntimeNodeResourceLatestReadModelQueryService(
    private val repository: SpringDataRuntimeNodeResourceLatestReadModelRepository
) : QueryService<RuntimeNodeResourceLatestReadModelEntity>() {
    fun findByCriteria(criteria: RuntimeNodeResourceLatestReadModelCriteria?, pageable: Pageable): Page<RuntimeNodeResourceLatestReadModel> =
    ...
    private fun createSpecification(criteria: RuntimeNodeResourceLatestReadModelCriteria?): Specification<RuntimeNodeResourceLatestReadModelEntity> {
        ...
        if (criteria != null) {
            ...
            criteria.runtimeNodeName?.let { specification = specification.and(buildSpecification(it, Function<Root<RuntimeNodeResourceLatestReadModelEntity>, Expression<String>> { root -> root.get("runtimeNodeName") })) }
            criteria.nodeReady?.let { specification = specification.and(buildSpecification(it, Function<Root<RuntimeNodeResourceLatestReadModelEntity>, Expression<Boolean>> { root -> root.get("nodeReady") })) }
            criteria.allocatableCpuCores?.let { specification = specification.and(buildExpressionRangeSpecification(it, Function<Root<RuntimeNodeResourceLatestReadModelEntity>, Expression<Int>> { root -> root.get("allocatableCpuCores") })) }
            criteria.allocatableMemoryGb?.let { specification = specification.and(buildExpressionRangeSpecification(it, Function<Root<RuntimeNodeResourceLatestReadModelEntity>, Expression<Int>> { root -> root.get("allocatableMemoryGb") })) }
            criteria.allocatableGpuCount?.let { specification = specification.and(buildExpressionRangeSpecification(it, Function<Root<RuntimeNodeResourceLatestReadModelEntity>, Expression<Int>> { root -> root.get("allocatableGpuCount") })) }
            criteria.allocatedCpuCores?.let { specification = specification.and(buildExpressionRangeSpecification(it, Function<Root<RuntimeNodeResourceLatestReadModelEntity>, Expression<Int>> { root -> root.get("allocatedCpuCores") })) }
            criteria.allocatedMemoryGb?.let { specification = specification.and(buildExpressionRangeSpecification(it, Function<Root<RuntimeNodeResourceLatestReadModelEntity>, Expression<Int>> { root -> root.get("allocatedMemoryGb") })) }
            criteria.allocatedGpuCount?.let { specification = specification.and(buildExpressionRangeSpecification(it, Function<Root<RuntimeNodeResourceLatestReadModelEntity>, Expression<Int>> { root -> root.get("allocatedGpuCount") })) }
            criteria.availableCpuCores?.let { specification = specification.and(buildExpressionRangeSpecification(it, Function<Root<RuntimeNodeResourceLatestReadModelEntity>, Expression<Int>> { root -> root.get("availableCpuCores") })) }
            criteria.availableMemoryGb?.let { specification = specification.and(buildExpressionRangeSpecification(it, Function<Root<RuntimeNodeResourceLatestReadModelEntity>, Expression<Int>> { root -> root.get("availableMemoryGb") })) }
            criteria.availableGpuCount?.let { specification = specification.and(buildExpressionRangeSpecification(it, Function<Root<RuntimeNodeResourceLatestReadModelEntity>, Expression<Int>> { root -> root.get("availableGpuCount") })) }
    ...
    private fun buildLocalDateTimeRangeSpecification(
        filter: RangeFilter<*>,
        field: Function<Root<RuntimeNodeResourceLatestReadModelEntity>, Expression<LocalDateTime>>
    ): Specification<RuntimeNodeResourceLatestReadModelEntity> =
    ...
    private fun <X : Comparable<in X>> buildExpressionRangeSpecification(
        ...
        field: Function<Root<RuntimeNodeResourceLatestReadModelEntity>, Expression<X>>
    ): Specification<RuntimeNodeResourceLatestReadModelEntity> =
        Specification { root, _, builder ->
            val expression = field.apply(root)
            val predicates = mutableListOf<jakarta.persistence.criteria.Predicate>()
