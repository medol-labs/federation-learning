...
import { RevokeRuntimeIdentityCommandSchema, type RevokeRuntimeIdentityCommandInput } from "@/contexts/domain/schemas";
...
export const RuntimeIdentityCatalogRevokeRuntimeIdentity = () => {
  ...
  async function onSubmit(values: RevokeRuntimeIdentityCommandInput) {
    const result = await runFormBehavior<RevokeRuntimeIdentityCommandInput>(
      frontendComposition,
      "behavior:runtime-identity-catalog:revokeRuntimeIdentity",
      {
      ...defaultValues,
      ...values,
      } as RevokeRuntimeIdentityCommandInput,
