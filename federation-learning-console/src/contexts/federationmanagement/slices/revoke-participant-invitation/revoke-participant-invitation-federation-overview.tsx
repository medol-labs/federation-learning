...
export const FederationOverviewRevokeParticipantInvitation = () => {
  ...
  async function onSubmit(values: RevokeParticipantInvitationCommandInput) {
    const result = await runFormBehavior<RevokeParticipantInvitationCommandInput>(
      frontendComposition,
      "behavior:federation-overview:revokeParticipantInvitation",
      {
      ...defaultValues,
      ...values,
      } as RevokeParticipantInvitationCommandInput,
  ...
  return (
    <CreateView>
      <CreateViewHeader title={t("resources.federation_overview.commands.revokeParticipantInvitation.label", "Revoke Participant Invitation")} />
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit, (errors) => console.error("RevokeParticipantInvitation validation failed", errors))} className="space-y-8">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.federation_overview.commands.revokeParticipantInvitation.fields.federationName.label", "Federation Name")}</FormLabel>
                <FormControl>
                  <Input
                    {...field}
                    value={field.value || ""}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.federation_overview.commands.revokeParticipantInvitation.fields.organizationId.label", "Organization Id")}</FormLabel>
                <ResourceSelect
                  withFormControl
                  ...
                  placeholder={t("resources.federation_overview.commands.revokeParticipantInvitation.fields.organizationId.placeholder", "Select Organization Id")}
                  meta={{
                    idField: "organizationId",
                    label: t("resources.federation_overview.commands.revokeParticipantInvitation.fields.organizationId.label", "Organization Directory"),
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.federation_overview.commands.revokeParticipantInvitation.fields.organizationName.label", "Organization Name")}</FormLabel>
                <FormControl>
                  <Input
                    {...field}
                    value={field.value || ""}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.federation_overview.commands.revokeParticipantInvitation.fields.revokeReason.label", "Revoke Reason")}</FormLabel>
                <FormControl>
                  <Input
                    {...field}
                    value={field.value || ""}
