...
export const FederationOverviewReactivateFederation = () => {
  ...
  async function onSubmit(values: ReactivateFederationCommandInput) {
    const result = await runFormBehavior<ReactivateFederationCommandInput>(
      frontendComposition,
      "behavior:federation-overview:reactivateFederation",
      {
      ...defaultValues,
      ...values,
      } as ReactivateFederationCommandInput,
