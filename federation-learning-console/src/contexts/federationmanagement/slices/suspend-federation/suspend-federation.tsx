...
import { SuspendFederationCommandSchema, type SuspendFederationCommandInput } from "@/contexts/domain/schemas";
...
export const FederationOverviewSuspendFederation = () => {
  ...
  } as unknown as Partial<SuspendFederationCommandInput>;
  ...
  async function onSubmit(values: SuspendFederationCommandInput) {
    const result = await runFormBehavior<SuspendFederationCommandInput>(
      frontendComposition,
      "behavior:federation-overview:suspendFederation",
      {
      ...defaultValues,
      ...values,
      } as SuspendFederationCommandInput,
