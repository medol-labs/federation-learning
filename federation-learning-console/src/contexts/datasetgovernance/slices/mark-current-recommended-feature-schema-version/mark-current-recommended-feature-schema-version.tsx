...
export const FeatureSchemaCatalogMarkCurrentRecommendedFeatureSchemaVersion = () => {
  ...
  async function onSubmit(values: MarkCurrentRecommendedFeatureSchemaVersionCommandInput) {
    const result = await runFormBehavior<MarkCurrentRecommendedFeatureSchemaVersionCommandInput>(
      frontendComposition,
      "behavior:feature-schema-catalog:markCurrentRecommendedFeatureSchemaVersion",
      {
      ...defaultValues,
      ...values,
      } as MarkCurrentRecommendedFeatureSchemaVersionCommandInput,
