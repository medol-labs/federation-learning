...
import { SupersedeFeatureSchemaVersionCommandSchema, type SupersedeFeatureSchemaVersionCommandInput } from "@/contexts/domain/schemas";
...
export const FeatureSchemaCatalogSupersedeFeatureSchemaVersion = () => {
  ...
  async function onSubmit(values: SupersedeFeatureSchemaVersionCommandInput) {
    const result = await runFormBehavior<SupersedeFeatureSchemaVersionCommandInput>(
      frontendComposition,
      "behavior:feature-schema-catalog:supersedeFeatureSchemaVersion",
      {
      ...defaultValues,
      ...values,
      } as SupersedeFeatureSchemaVersionCommandInput,
