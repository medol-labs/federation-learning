...
import { ResolveTrainingAlertCommandSchema, type ResolveTrainingAlertCommandInput } from "@/contexts/domain/schemas";
...
export const TrainingAlertCatalogResolveTrainingAlert = () => {
  ...
  async function onSubmit(values: ResolveTrainingAlertCommandInput) {
    const result = await runFormBehavior<ResolveTrainingAlertCommandInput>(
      frontendComposition,
      "behavior:training-alert-catalog:resolveTrainingAlert",
      {
      ...defaultValues,
      ...values,
      } as ResolveTrainingAlertCommandInput,
