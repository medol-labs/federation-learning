...
import { AcknowledgeTrainingAlertCommandSchema, type AcknowledgeTrainingAlertCommandInput } from "@/contexts/domain/schemas";
...
export const TrainingAlertCatalogAcknowledgeTrainingAlert = () => {
  ...
  async function onSubmit(values: AcknowledgeTrainingAlertCommandInput) {
    const result = await runFormBehavior<AcknowledgeTrainingAlertCommandInput>(
      frontendComposition,
      "behavior:training-alert-catalog:acknowledgeTrainingAlert",
      {
      ...defaultValues,
      ...values,
      } as AcknowledgeTrainingAlertCommandInput,
