...
import { FailSecureAggregationSessionCommandSchema, type FailSecureAggregationSessionCommandInput } from "@/contexts/domain/schemas";
...
export const SecureAggregationSessionCatalogFailSecureAggregationSession = () => {
  ...
  async function onSubmit(values: FailSecureAggregationSessionCommandInput) {
    const result = await runFormBehavior<FailSecureAggregationSessionCommandInput>(
      frontendComposition,
      "behavior:secure-aggregation-session-catalog:failSecureAggregationSession",
      {
      ...defaultValues,
      ...values,
      } as FailSecureAggregationSessionCommandInput,
