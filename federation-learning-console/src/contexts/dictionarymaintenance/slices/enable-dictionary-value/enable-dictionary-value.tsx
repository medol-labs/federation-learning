...
import { EnableDictionaryValueCommandSchema, type EnableDictionaryValueCommandInput } from "@/contexts/domain/schemas";
...
export const DictionaryValueCatalogEnableDictionaryValue = () => {
  ...
  async function onSubmit(values: EnableDictionaryValueCommandInput) {
    const result = await runFormBehavior<EnableDictionaryValueCommandInput>(
      frontendComposition,
      "behavior:dictionary-value-catalog:enableDictionaryValue",
      {
      ...defaultValues,
      ...values,
      } as EnableDictionaryValueCommandInput,
