...
import { UpdateDictionaryCommandSchema, type UpdateDictionaryCommandInput } from "@/contexts/domain/schemas";
...
export const DictionaryCatalogUpdateDictionary = () => {
  ...
  async function onSubmit(values: UpdateDictionaryCommandInput) {
    const result = await runFormBehavior<UpdateDictionaryCommandInput>(
      frontendComposition,
      "behavior:dictionary-catalog:updateDictionary",
      {
      ...defaultValues,
      ...values,
      } as UpdateDictionaryCommandInput,
