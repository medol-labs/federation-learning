...
export const DictionaryCatalogAddDictionaryValue = () => {
  ...
  async function onSubmit(values: AddDictionaryValueCommandInput) {
    const result = await runFormBehavior<AddDictionaryValueCommandInput>(
      frontendComposition,
      "behavior:dictionary-catalog:addDictionaryValue",
      {
      ...defaultValues,
      ...values,
  ...
  return (
    <CreateView>
      <CreateViewHeader title={t("resources.dictionary_catalog.commands.addDictionaryValue.label", "Add Dictionary Value")} />
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit, (errors) => console.error("AddDictionaryValue validation failed", errors))} className="space-y-8">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.dictionary_catalog.commands.addDictionaryValue.fields.dictionaryId.label", "Dictionary Id")}</FormLabel>
                <ResourceSelect
                  withFormControl
                  resource="dictionary_catalog"
                  dataProviderName="federation-learning-support"
                  ...
                  placeholder={t("resources.dictionary_catalog.commands.addDictionaryValue.fields.dictionaryId.placeholder", "Select Dictionary Id")}
                  meta={{
                    idField: "dictionaryId",
                    label: t("resources.dictionary_catalog.commands.addDictionaryValue.fields.dictionaryId.label", "Dictionary Catalog"),
                    aggregateRoute: "dictionary",
                    queryRoute: "dictionarycatalog",
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.dictionary_catalog.commands.addDictionaryValue.fields.dictionaryCode.label", "Dictionary Code")}</FormLabel>
                <FormControl>
                  <Input
                    {...field}
                    value={field.value || ""}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.dictionary_catalog.commands.addDictionaryValue.fields.valueCode.label", "Value Code")}</FormLabel>
                <FormControl>
                  <Input
                    {...field}
                    value={field.value || ""}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.dictionary_catalog.commands.addDictionaryValue.fields.displayOrder.label", "Display Order")}</FormLabel>
                <FormControl>
                  <Input
                    type="number"
                    {...field}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.dictionary_catalog.commands.addDictionaryValue.fields.description.label", "Description")}</FormLabel>
                <FormControl>
                  <Textarea
                    {...field}
                    value={field.value || ""}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.dictionary_catalog.commands.addDictionaryValue.fields.active.label", "Active")}</FormLabel>
                <Select
                ...
                >
                  <FormControl>
                    <SelectTrigger>
                      <SelectValue placeholder={t("resources.dictionary_catalog.commands.addDictionaryValue.fields.active.placeholder", "Select Active")} />
                    </SelectTrigger>
                  </FormControl>
                  <SelectContent>
