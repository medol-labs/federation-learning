...
export const UserOrganizationMembershipDirectoryBindUserAccountToOrganization = () => {
  ...
  async function onSubmit(values: BindUserAccountToOrganizationCommandInput) {
    const result = await runFormBehavior<BindUserAccountToOrganizationCommandInput>(
      frontendComposition,
      "behavior:user-organization-membership-directory:bindUserAccountToOrganization",
      {
      ...defaultValues,
      ...values,
      } as BindUserAccountToOrganizationCommandInput,
