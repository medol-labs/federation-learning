...
import { RegisterOrganizationCommandSchema, type RegisterOrganizationCommandInput } from "@/contexts/domain/schemas";
...
export const OrganizationDirectoryRegisterOrganization = () => {
  ...
  async function onSubmit(values: RegisterOrganizationCommandInput) {
    const result = await runFormBehavior<RegisterOrganizationCommandInput>(
      frontendComposition,
      "behavior:organization-directory:registerOrganization",
      {
      ...defaultValues,
      ...values,
      } as RegisterOrganizationCommandInput,
