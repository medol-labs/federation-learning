...
export const TrainingRoundProgressSubmitModelUpdateSubmission = () => {
  ...
  async function onSubmit(values: SubmitModelUpdateSubmissionCommandInput) {
    const result = await runFormBehavior<SubmitModelUpdateSubmissionCommandInput>(
      frontendComposition,
      "behavior:training-round-progress:submitModelUpdateSubmission",
      {
      ...defaultValues,
      ...values,
      } as SubmitModelUpdateSubmissionCommandInput,
