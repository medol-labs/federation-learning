...
export const TrainingRunConfigurationCatalogUpdateTrainingRunConfiguration = () => {
  ...
  async function onSubmit(values: UpdateTrainingRunConfigurationCommandInput) {
    const result = await runFormBehavior<UpdateTrainingRunConfigurationCommandInput>(
      frontendComposition,
      "behavior:training-run-configuration-catalog:updateTrainingRunConfiguration",
      {
      ...defaultValues,
      ...values,
      } as UpdateTrainingRunConfigurationCommandInput,
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit, (errors) => console.error("UpdateTrainingRunConfiguration validation failed", errors))} className="space-y-8">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.training_run_configuration_catalog.commands.updateTrainingRunConfiguration.fields.runtimeEngineProfileId.label", "Runtime Engine Profile Id")}</FormLabel>
                <ResourceSelect
                  withFormControl
