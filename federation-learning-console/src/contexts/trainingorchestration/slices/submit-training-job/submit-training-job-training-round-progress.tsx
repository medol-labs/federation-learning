...
export const TrainingRoundProgressSubmitTrainingJob = () => {
  ...
  async function onSubmit(values: SubmitTrainingJobCommandInput) {
    const result = await runFormBehavior<SubmitTrainingJobCommandInput>(
      frontendComposition,
      "behavior:training-round-progress:submitTrainingJob",
      {
      ...defaultValues,
      ...values,
      } as SubmitTrainingJobCommandInput,
  ...
  return (
    <CreateView>
      <CreateViewHeader title={t("resources.training_round_progress.commands.submitTrainingJob.label", "Submit Training Job")} />
      <Form {...form}>
