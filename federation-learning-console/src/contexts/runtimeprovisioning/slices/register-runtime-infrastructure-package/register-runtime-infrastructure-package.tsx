...
import { RegisterRuntimeInfrastructurePackageCommandSchema, type RegisterRuntimeInfrastructurePackageCommandInput } from "@/contexts/domain/schemas";
...
export const RuntimeInfrastructurePackageCatalogRegisterRuntimeInfrastructurePackage = () => {
  ...
  async function onSubmit(values: RegisterRuntimeInfrastructurePackageCommandInput) {
    const result = await runFormBehavior<RegisterRuntimeInfrastructurePackageCommandInput>(
      frontendComposition,
      "behavior:runtime-infrastructure-package-catalog:registerRuntimeInfrastructurePackage",
      {
      ...defaultValues,
      ...values,
      } as RegisterRuntimeInfrastructurePackageCommandInput,
