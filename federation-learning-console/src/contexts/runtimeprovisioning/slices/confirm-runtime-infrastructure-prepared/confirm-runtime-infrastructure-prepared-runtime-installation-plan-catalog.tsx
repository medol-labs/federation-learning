...
export const RuntimeInstallationPlanCatalogConfirmRuntimeInfrastructurePrepared = () => {
  ...
  return (
    <CreateView>
      <CreateViewHeader title={t("resources.runtime_installation_plan_catalog.commands.confirmRuntimeInfrastructurePrepared.label", "Confirm Runtime Infrastructure Prepared")} />
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit, (errors) => console.error("ConfirmRuntimeInfrastructurePrepared validation failed", errors))} className="space-y-8">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.runtime_installation_plan_catalog.commands.confirmRuntimeInfrastructurePrepared.fields.organizationId.label", "Organization Id")}</FormLabel>
                <ResourceSelect
                  withFormControl
                  ...
                  placeholder={t("resources.runtime_installation_plan_catalog.commands.confirmRuntimeInfrastructurePrepared.fields.organizationId.placeholder", "Select Organization Id")}
                  meta={{
                    idField: "organizationId",
                    label: t("resources.runtime_installation_plan_catalog.commands.confirmRuntimeInfrastructurePrepared.fields.organizationId.label", "Organization Directory"),
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.runtime_installation_plan_catalog.commands.confirmRuntimeInfrastructurePrepared.fields.organizationName.label", "Organization Name")}</FormLabel>
                <FormControl>
                  <Input
                    {...field}
                    value={field.value || ""}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.runtime_installation_plan_catalog.commands.confirmRuntimeInfrastructurePrepared.fields.runtimeInfrastructurePackageId.label", "Runtime Infrastructure Package Id")}</FormLabel>
                <ResourceSelect
                  withFormControl
                  ...
                  placeholder={t("resources.runtime_installation_plan_catalog.commands.confirmRuntimeInfrastructurePrepared.fields.runtimeInfrastructurePackageId.placeholder", "Select Runtime Infrastructure Package Id")}
                  meta={{
                    idField: "runtimeInfrastructurePackageId",
                    label: t("resources.runtime_installation_plan_catalog.commands.confirmRuntimeInfrastructurePrepared.fields.runtimeInfrastructurePackageId.label", "Runtime Infrastructure Package Catalog"),
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.runtime_installation_plan_catalog.commands.confirmRuntimeInfrastructurePrepared.fields.runtimeInfrastructurePackageName.label", "Runtime Infrastructure Package Name")}</FormLabel>
                <FormControl>
                  <Input
                    {...field}
                    value={field.value || ""}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.runtime_installation_plan_catalog.commands.confirmRuntimeInfrastructurePrepared.fields.runtimeInfrastructurePackageVersion.label", "Runtime Infrastructure Package Version")}</FormLabel>
                <FormControl>
                  <Input
                    {...field}
                    value={field.value || ""}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.runtime_installation_plan_catalog.commands.confirmRuntimeInfrastructurePrepared.fields.runtimeEnvironmentType.label", "Runtime Environment Type")}</FormLabel>
                <ResourceSelect
                  withFormControl
                  ...
                  meta={{
                    ...
                    label: t("resources.runtime_installation_plan_catalog.commands.confirmRuntimeInfrastructurePrepared.fields.runtimeEnvironmentType.label", "Dictionary Value Catalog"),
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.runtime_installation_plan_catalog.commands.confirmRuntimeInfrastructurePrepared.fields.runtimeName.label", "Runtime Name")}</FormLabel>
                <FormControl>
                  <Input
                    {...field}
                    value={field.value || ""}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.runtime_installation_plan_catalog.commands.confirmRuntimeInfrastructurePrepared.fields.agentInstallMode.label", "Agent Install Mode")}</FormLabel>
                <ResourceSelect
                  withFormControl
                  resource="dictionary_value_catalog"
                  dataProviderName="federation-learning-support"
                  ...
                  meta={{
                    idField: "dictionaryValueId",
                    label: t("resources.runtime_installation_plan_catalog.commands.confirmRuntimeInfrastructurePrepared.fields.agentInstallMode.label", "Dictionary Value Catalog"),
                    aggregateRoute: "dictionaryvalue",
                    queryRoute: "dictionaryvaluecatalog",
                    queryFields: ["dictionaryCode","active","state"],
                  }}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.runtime_installation_plan_catalog.commands.confirmRuntimeInfrastructurePrepared.fields.expectedNodeCount.label", "Expected Node Count")}</FormLabel>
                <FormControl>
                  <Input
                    type="number"
                    {...field}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.runtime_installation_plan_catalog.commands.confirmRuntimeInfrastructurePrepared.fields.preparedNodeCount.label", "Prepared Node Count")}</FormLabel>
                <FormControl>
                  <Input
                    type="number"
                    {...field}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.runtime_installation_plan_catalog.commands.confirmRuntimeInfrastructurePrepared.fields.preparationNotes.label", "Preparation Notes")}</FormLabel>
                <FormControl>
                  <Textarea
                    {...field}
                    value={field.value || ""}
