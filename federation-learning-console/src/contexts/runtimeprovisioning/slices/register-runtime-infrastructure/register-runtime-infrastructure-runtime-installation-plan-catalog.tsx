...
export const RuntimeInstallationPlanCatalogRegisterRuntimeInfrastructure = () => {
  ...
  async function onSubmit(values: RegisterRuntimeInfrastructureCommandInput) {
    const result = await runFormBehavior<RegisterRuntimeInfrastructureCommandInput>(
      frontendComposition,
      "behavior:runtime-installation-plan-catalog:registerRuntimeInfrastructure",
      {
      ...defaultValues,
      ...values,
      } as RegisterRuntimeInfrastructureCommandInput,
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit, (errors) => console.error("RegisterRuntimeInfrastructure validation failed", errors))} className="space-y-8">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.runtime_installation_plan_catalog.commands.registerRuntimeInfrastructure.fields.organizationId.label", "Organization Id")}</FormLabel>
                <ResourceSelect
                  withFormControl
                  ...
                  placeholder={t("resources.runtime_installation_plan_catalog.commands.registerRuntimeInfrastructure.fields.organizationId.placeholder", "Select Organization Id")}
                  meta={{
                    idField: "organizationId",
                    label: t("resources.runtime_installation_plan_catalog.commands.registerRuntimeInfrastructure.fields.organizationId.label", "Organization Directory"),
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.runtime_installation_plan_catalog.commands.registerRuntimeInfrastructure.fields.organizationName.label", "Organization Name")}</FormLabel>
                <FormControl>
                  <Input
                    {...field}
                    value={field.value || ""}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.runtime_installation_plan_catalog.commands.registerRuntimeInfrastructure.fields.runtimeInfrastructurePackageId.label", "Runtime Infrastructure Package Id")}</FormLabel>
                <ResourceSelect
                  withFormControl
                  ...
                  placeholder={t("resources.runtime_installation_plan_catalog.commands.registerRuntimeInfrastructure.fields.runtimeInfrastructurePackageId.placeholder", "Select Runtime Infrastructure Package Id")}
                  meta={{
                    idField: "runtimeInfrastructurePackageId",
                    label: t("resources.runtime_installation_plan_catalog.commands.registerRuntimeInfrastructure.fields.runtimeInfrastructurePackageId.label", "Runtime Infrastructure Package Catalog"),
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.runtime_installation_plan_catalog.commands.registerRuntimeInfrastructure.fields.runtimeInfrastructurePackageName.label", "Runtime Infrastructure Package Name")}</FormLabel>
                <FormControl>
                  <Input
                    {...field}
                    value={field.value || ""}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.runtime_installation_plan_catalog.commands.registerRuntimeInfrastructure.fields.runtimeInfrastructurePackageVersion.label", "Runtime Infrastructure Package Version")}</FormLabel>
                <FormControl>
                  <Input
                    {...field}
                    value={field.value || ""}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.runtime_installation_plan_catalog.commands.registerRuntimeInfrastructure.fields.runtimeEnvironmentType.label", "Runtime Environment Type")}</FormLabel>
                <ResourceSelect
                  withFormControl
                  ...
                  placeholder={t("resources.runtime_installation_plan_catalog.commands.registerRuntimeInfrastructure.fields.runtimeEnvironmentType.placeholder", "Select Runtime Environment Type")}
                  ...
                  meta={{
                    ...
                    label: t("resources.runtime_installation_plan_catalog.commands.registerRuntimeInfrastructure.fields.runtimeEnvironmentType.label", "Dictionary Value Catalog"),
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.runtime_installation_plan_catalog.commands.registerRuntimeInfrastructure.fields.runtimeName.label", "Runtime Name")}</FormLabel>
                <FormControl>
                  <Input
                    {...field}
                    value={field.value || ""}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.runtime_installation_plan_catalog.commands.registerRuntimeInfrastructure.fields.agentInstallMode.label", "Agent Install Mode")}</FormLabel>
                <ResourceSelect
                  withFormControl
                  resource="dictionary_value_catalog"
                  dataProviderName="federation-learning-support"
                  ...
                  placeholder={t("resources.runtime_installation_plan_catalog.commands.registerRuntimeInfrastructure.fields.agentInstallMode.placeholder", "Select Agent Install Mode")}
                  filters={[{"field":"dictionaryCode","operator":"eq","value":"RUNTIME_AGENT_INSTALL_MODE"},{"field":"state","operator":"eq","value":"ACTIVE"}]}
                  sorters={[{"field":"displayOrder","order":"asc"}]}
                  pagination={{"currentPage":1,"pageSize":100,"mode":"server"}}
                  meta={{
                    idField: "dictionaryValueId",
                    label: t("resources.runtime_installation_plan_catalog.commands.registerRuntimeInfrastructure.fields.agentInstallMode.label", "Dictionary Value Catalog"),
                    aggregateRoute: "dictionaryvalue",
                    queryRoute: "dictionaryvaluecatalog",
                    queryFields: ["dictionaryCode","active","state"],
                  }}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.runtime_installation_plan_catalog.commands.registerRuntimeInfrastructure.fields.expectedNodeCount.label", "Expected Node Count")}</FormLabel>
                <FormControl>
                  <Input
                    type="number"
                    {...field}
