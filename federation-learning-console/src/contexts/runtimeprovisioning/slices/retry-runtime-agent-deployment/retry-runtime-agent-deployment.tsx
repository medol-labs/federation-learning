...
export const RuntimeInstallationPlanCatalogRetryRuntimeAgentDeployment = () => {
  ...
  async function onSubmit(values: RetryRuntimeAgentDeploymentCommandInput) {
    const result = await runFormBehavior<RetryRuntimeAgentDeploymentCommandInput>(
      frontendComposition,
      "behavior:runtime-installation-plan-catalog:retryRuntimeAgentDeployment",
      {
      ...defaultValues,
      ...values,
      } as RetryRuntimeAgentDeploymentCommandInput,
