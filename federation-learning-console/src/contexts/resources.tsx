...
export const resources: IResourceItem[] = [
  ...
  },
  {
    ...
    meta: {
      ...
      commands: {
        ...
        rollbackModel: { label: "Rollback Model", i18nKey: "resources.model_catalog.commands.rollbackModel.label", route: "/model-catalog/:id/command/rollback-model", dataProviderName: "federation-learning-platform", enabledField: "canRollback", stateField: "state", allowedStates: ["Production"] },
        retireModel: { label: "Retire Model", i18nKey: "resources.model_catalog.commands.retireModel.label", route: "/model-catalog/:id/command/retire-model", dataProviderName: "federation-learning-platform", enabledField: "canRetire", stateField: "state", allowedStates: ["Production"] },
      },
      canDelete: false,
    },
  },
  ...
  },
  {
    ...
    meta: {
      ...
      commands: {
        registerPermission: { label: "Register Permission", i18nKey: "resources.permission_catalog.commands.registerPermission.label", route: "/permission-catalog/command/register-permission", dataProviderName: "federation-learning-support" },
      },
      canDelete: false,
    },
  },
  ...
  },
  {
    ...
    meta: {
      ...
      commands: {
        registerRuntimeEngineProfile: { label: "Register Runtime Engine Profile", i18nKey: "resources.runtime_engine_profile_catalog.commands.registerRuntimeEngineProfile.label", route: "/runtime-engine-profile-catalog/command/register-runtime-engine-profile", dataProviderName: "federation-learning-platform" },
      },
      canDelete: false,
    },
  },
  ...
  },
  {
    ...
    meta: {
      ...
      commands: {
        registerUserAccount: { label: "Register User Account", i18nKey: "resources.user_account_catalog.commands.registerUserAccount.label", route: "/user-account-catalog/command/register-user-account", dataProviderName: "federation-learning-support" },
        generateUserAccountLoginPassword: { label: "Generate User Account Login Password", i18nKey: "resources.user_account_catalog.commands.generateUserAccountLoginPassword.label", route: "/user-account-catalog/:id/command/generate-user-account-login-password", dataProviderName: "federation-learning-support" },
