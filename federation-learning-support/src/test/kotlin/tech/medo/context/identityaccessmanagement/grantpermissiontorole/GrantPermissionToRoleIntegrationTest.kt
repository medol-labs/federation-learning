...
@SpringBootTest(properties = [
    ...
    "spring.datasource.url=jdbc:h2:mem:grant-permission-to-role-integration-test;DB_CLOSE_DELAY=-1",
...
class GrantPermissionToRoleIntegrationTest(
    @Autowired private val commandGateway: CommandGateway
) {
    @Test
    fun GrantPermissionToRoleintegration() {
        val command = GrantPermissionToRoleCommand(
