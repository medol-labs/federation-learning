...
class ReleaseRuntimeEngineJobAfterStartFailureResource(
    private val commandGateway: CommandGateway
) {
    @PreAuthorize("hasAuthority('*:*') or hasAuthority('release_runtime_engine_job_after_start_failure:execute')")
