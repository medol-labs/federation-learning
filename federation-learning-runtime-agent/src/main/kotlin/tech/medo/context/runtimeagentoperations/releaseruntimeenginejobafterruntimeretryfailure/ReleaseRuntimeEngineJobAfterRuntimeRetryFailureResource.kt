...
class ReleaseRuntimeEngineJobAfterRuntimeRetryFailureResource(
    private val commandGateway: CommandGateway
) {
    @PreAuthorize("hasAuthority('*:*') or hasAuthority('release_runtime_engine_job_after_runtime_retry_failure:execute')")
