...
docker compose up -d umadb federation-learning-runtime-agent-postgres./mvnw -pl federation-learning-runtime-agent -am spring-boot:run
```
...
./mvnw -pl federation-learning-runtime-agent jib:dockerBuild
```
