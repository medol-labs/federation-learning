        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">{formatValue(record?.fileId, t)}</p>
            </div>
            <Separator />
            <div>
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">{formatValue(record?.fileLocation, t)}</p>
            </div>
            <Separator />
            <div>
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">{formatValue(record?.uploadedAt, t)}</p>
            </div>
            <Separator />
            <div>
              <h4 className="mb-2 text-sm font-medium">{t("resources.uploaded_file_catalog.fields.referencedAt.label", "Referenced At")}</h4>
              <p className="text-sm text-muted-foreground">{formatValue(record?.referencedAt, t)}</p>
            </div>
            <Separator />
            <div>
              ...
              <p className="text-sm text-muted-foreground">{formatValue(record?.referencedByContext, t)}</p>
            </div>
            <Separator />
            <div>
              ...
              <p className="text-sm text-muted-foreground">{formatValue(record?.referencedByCommand, t)}</p>
            </div>
            <Separator />
            <div>
              ...
              <p className="text-sm text-muted-foreground">{formatValue(record?.referencedByCommandId, t)}</p>
            </div>
            <Separator />
            <div>
