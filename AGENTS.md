...
- This is a monorepo: generated backend code lives under `federation-learning-platform/`, generated frontend code under `federation-learning-console/`, runtime execution code under `runtime-engine/`, and bootstrap scripts under `dictionary-init/`.
