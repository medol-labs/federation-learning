...
class DatasetReadinessReadModelProjector(private val repository: DatasetReadinessReadModelRepository) {
    ...
    fun on(event: OrganizationRegisteredEvent) {
        // Skipped: OrganizationRegisteredEvent does not provide enough key fields to locate DatasetReadinessReadModelProjection.
    }

    @EventHandler
    fun on(event: RuntimeConnectionEstablishedEvent) {
        // Skipped: RuntimeConnectionEstablishedEvent does not provide enough key fields to locate DatasetReadinessReadModelProjection.
    }

    @EventHandler
    fun on(event: FeatureSchemaDefinedEvent) {
        // Skipped: FeatureSchemaDefinedEvent does not provide enough key fields to locate DatasetReadinessReadModelProjection.
    }
    ...
    fun on(event: RuntimeAgentOfflineDetectedEvent) {
        // Skipped: RuntimeAgentOfflineDetectedEvent does not provide enough key fields to locate DatasetReadinessReadModelProjection.
    }

    @EventHandler
    fun on(event: RuntimeAgentRecoveredEvent) {
        // Skipped: RuntimeAgentRecoveredEvent does not provide enough key fields to locate DatasetReadinessReadModelProjection.
    }
}
