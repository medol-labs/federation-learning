...
@Component
class AuditDatasetApprovalRevokedProcessor(private val commandGateway: CommandGateway) {
    @EventHandler
    fun on(event: DatasetTrainingApprovalRevokedEvent): java.util.concurrent.CompletableFuture<AppendAuditTrailCommand> =
