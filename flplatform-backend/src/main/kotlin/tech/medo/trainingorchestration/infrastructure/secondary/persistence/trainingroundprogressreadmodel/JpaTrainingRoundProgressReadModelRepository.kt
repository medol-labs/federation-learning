...
@Repository
class JpaTrainingRoundProgressReadModelRepository(private val jpaRepository: SpringDataTrainingRoundProgressReadModelRepository) : TrainingRoundProgressReadModelRepository {
    ...
    private fun TrainingRoundProgressReadModelEntity.toProjection(): TrainingRoundProgressReadModelProjection =
        TrainingRoundProgressReadModelProjection().also {
            ...
            it.selectedOrganizationIds = this@toProjection.selectedOrganizationIds
            it.selectedParticipants = this@toProjection.selectedParticipants
            ...
            it.artifactRefs = this@toProjection.artifactRefs
            it.rejectedUpdateReasons = this@toProjection.rejectedUpdateReasons
    ...
    private fun TrainingRoundProgressReadModelProjection.toEntity(): TrainingRoundProgressReadModelEntity =
        TrainingRoundProgressReadModelEntity().also {
            ...
            it.selectedOrganizationIds = this@toEntity.selectedOrganizationIds
            it.selectedParticipants = this@toEntity.selectedParticipants
            ...
            it.artifactRefs = this@toEntity.artifactRefs
            it.rejectedUpdateReasons = this@toEntity.rejectedUpdateReasons
