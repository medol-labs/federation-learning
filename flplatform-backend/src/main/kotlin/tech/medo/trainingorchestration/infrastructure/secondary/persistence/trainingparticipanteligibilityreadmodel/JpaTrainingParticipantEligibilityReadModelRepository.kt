...
@Repository
class JpaTrainingParticipantEligibilityReadModelRepository(private val jpaRepository: SpringDataTrainingParticipantEligibilityReadModelRepository) : TrainingParticipantEligibilityReadModelRepository {
    ...
    private fun TrainingParticipantEligibilityReadModelEntity.toProjection(): TrainingParticipantEligibilityReadModelProjection =
        TrainingParticipantEligibilityReadModelProjection().also {
            ...
            it.ineligibleReasons = this@toProjection.ineligibleReasons
            it.warningReasons = this@toProjection.warningReasons
    ...
    private fun TrainingParticipantEligibilityReadModelProjection.toEntity(): TrainingParticipantEligibilityReadModelEntity =
        TrainingParticipantEligibilityReadModelEntity().also {
            ...
            it.ineligibleReasons = this@toEntity.ineligibleReasons
            it.warningReasons = this@toEntity.warningReasons
