...
export const backendModules = [
  ...
  },
  {
    ...
    label: "Federation Learning Console",
    dataProviderName: "federation-learning-console",
    apiUrl: import.meta.env.VITE_FEDERATION_LEARNING_CONSOLE_API_URL ?? "http://localhost:8082",
...
export const resources: IResourceItem[] = [
  ...
  },
  {
    ...
    meta: {
      ...
      dataProviderName: "federation-learning-console",
      moduleName: "federation-learning-console",
      moduleLabel: "Federation Learning Console",
      commandRoute: "/agent-dataset-access-validation-catalog/:id/command/:command",
      commands: {
        validateAgentDatasetAccess: { label: "Validate Agent Dataset Access", i18nKey: "resources.agent_dataset_access_validation_catalog.commands.validateAgentDatasetAccess.label", route: "/agent-dataset-access-validation-catalog/command/validate-agent-dataset-access", dataProviderName: "federation-learning-console" },
  ...
  },
  {
    ...
    meta: {
      ...
      commands: {
        declareDataset: { label: "Declare Dataset", i18nKey: "resources.dataset_capability.commands.declareDataset.label", route: "/dataset-capability/command/declare-dataset", dataProviderName: "federation-learning-platform" },
        configureRuntimeDatasetBinding: { label: "Configure Runtime Dataset Binding", i18nKey: "resources.dataset_capability.commands.configureRuntimeDatasetBinding.label", route: "/dataset-capability/:id/command/configure-runtime-dataset-binding", dataProviderName: "federation-learning-platform" },
      },
      canDelete: false,
    },
  },
  {
    ...
    meta: {
      ...
      commands: {
        declareDataset: { label: "Declare Dataset", i18nKey: "resources.dataset_readiness.commands.declareDataset.label", route: "/dataset-readiness/command/declare-dataset", dataProviderName: "federation-learning-platform" },
        configureRuntimeDatasetBinding: { label: "Configure Runtime Dataset Binding", i18nKey: "resources.dataset_readiness.commands.configureRuntimeDatasetBinding.label", route: "/dataset-readiness/:id/command/configure-runtime-dataset-binding", dataProviderName: "federation-learning-platform" },
      },
      canDelete: false,
    },
  },
  ...
  },
  {
    ...
    meta: {
      ...
      commands: {
        ...
        createRuntimeInstallationPlan: { label: "Create Runtime Installation Plan", i18nKey: "resources.federation_membership_directory.commands.createRuntimeInstallationPlan.label", route: "/federation-membership-directory/:id/command/create-runtime-installation-plan", dataProviderName: "federation-learning-platform" },
      },
      canDelete: true,
    },
  },
  ...
  },
  {
    ...
    meta: {
      ...
      commands: {
        ...
        submitGlobalModelEvaluation: { label: "Submit Global Model Evaluation", i18nKey: "resources.model_artifact_catalog.commands.submitGlobalModelEvaluation.label", route: "/model-artifact-catalog/:id/command/submit-global-model-evaluation", dataProviderName: "federation-learning-platform" },
      },
      canDelete: false,
    },
  },
  ...
  },
  {
    ...
    meta: {
      ...
      commands: {
        retryRoundExecutionAfterStartFailure: { label: "Retry Round Execution After Start Failure", i18nKey: "resources.round_execution_catalog.commands.retryRoundExecutionAfterStartFailure.label", route: "/round-execution-catalog/:id/command/retry-round-execution-after-start-failure", dataProviderName: "federation-learning-console", stateField: "state", allowedStates: ["Running"] },
        completeRoundExecution: { label: "Complete Round Execution", i18nKey: "resources.round_execution_catalog.commands.completeRoundExecution.label", route: "/round-execution-catalog/:id/command/complete-round-execution", dataProviderName: "federation-learning-console", stateField: "state", allowedStates: ["Running"] },
        failRoundExecution: { label: "Fail Round Execution", i18nKey: "resources.round_execution_catalog.commands.failRoundExecution.label", route: "/round-execution-catalog/:id/command/fail-round-execution", dataProviderName: "federation-learning-console", stateField: "state", allowedStates: ["Running"] },
        retryRoundExecutionAfterRuntimeFailure: { label: "Retry Round Execution After Runtime Failure", i18nKey: "resources.round_execution_catalog.commands.retryRoundExecutionAfterRuntimeFailure.label", route: "/round-execution-catalog/:id/command/retry-round-execution-after-runtime-failure", dataProviderName: "federation-learning-console", stateField: "state", allowedStates: ["Failed"] },
        submitModelUpdateSubmission: { label: "Submit Model Update Submission", i18nKey: "resources.round_execution_catalog.commands.submitModelUpdateSubmission.label", route: "/round-execution-catalog/:id/command/submit-model-update-submission", dataProviderName: "federation-learning-console" },
      },
      canDelete: false,
    },
  },
  {
    ...
    meta: {
      ...
      commands: {
        reportRuntimeAgentStarted: { label: "Report Runtime Agent Started", i18nKey: "resources.runtime_agent_lifecycle_catalog.commands.reportRuntimeAgentStarted.label", route: "/runtime-agent-lifecycle-catalog/command/report-runtime-agent-started", dataProviderName: "federation-learning-console" },
      },
      canDelete: false,
    },
  },
  ...
  },
  {
    ...
    meta: {
      ...
      commands: {
        configureRuntimeDatasetBinding: { label: "Configure Runtime Dataset Binding", i18nKey: "resources.runtime_dataset_binding_catalog.commands.configureRuntimeDatasetBinding.label", route: "/runtime-dataset-binding-catalog/command/configure-runtime-dataset-binding", dataProviderName: "federation-learning-console" },
        validateAgentDatasetAccess: { label: "Validate Agent Dataset Access", i18nKey: "resources.runtime_dataset_binding_catalog.commands.validateAgentDatasetAccess.label", route: "/runtime-dataset-binding-catalog/:id/command/validate-agent-dataset-access", dataProviderName: "federation-learning-console" },
      },
      canDelete: false,
    },
  },
  {
    ...
    meta: {
      ...
      commands: {
        configureRuntimeDatasetBinding: { label: "Configure Runtime Dataset Binding", i18nKey: "resources.runtime_dataset_metadata_catalog.commands.configureRuntimeDatasetBinding.label", route: "/runtime-dataset-metadata-catalog/:id/command/configure-runtime-dataset-binding", dataProviderName: "federation-learning-console" },
      },
      canDelete: false,
    },
  },
  ...
  },
  {
    ...
    meta: {
      ...
      commands: {
        ...
        registerRuntimeInfrastructure: { label: "Register Runtime Infrastructure", i18nKey: "resources.runtime_installation_guide.commands.registerRuntimeInfrastructure.label", route: "/runtime-installation-guide/:id/command/register-runtime-infrastructure", dataProviderName: "federation-learning-platform" },
      },
      canDelete: false,
    },
  },
  {
    ...
    meta: {
      ...
      commands: {
        ...
        registerRuntimeInfrastructure: { label: "Register Runtime Infrastructure", i18nKey: "resources.runtime_installation_plan_catalog.commands.registerRuntimeInfrastructure.label", route: "/runtime-installation-plan-catalog/:id/command/register-runtime-infrastructure", dataProviderName: "federation-learning-platform" },
      },
      canDelete: false,
    },
  },
  {
    ...
    meta: {
      ...
      commands: {
        registerRuntimeInfrastructure: { label: "Register Runtime Infrastructure", i18nKey: "resources.runtime_node_inventory_view.commands.registerRuntimeInfrastructure.label", route: "/runtime-node-inventory-view/:id/command/register-runtime-infrastructure", dataProviderName: "federation-learning-platform" },
      },
      canDelete: false,
    },
  },
  ...
  },
  {
    ...
    meta: {
      ...
      commands: {
        ...
        suspendParticipant: { label: "Suspend Participant", i18nKey: "resources.training_participant_eligibility.commands.suspendParticipant.label", route: "/training-participant-eligibility/:id/command/suspend-participant", dataProviderName: "federation-learning-platform", stateField: "participantStatus", allowedStates: ["Active"] },
        removeParticipant: { label: "Remove Participant", i18nKey: "resources.training_participant_eligibility.commands.removeParticipant.label", route: "/training-participant-eligibility/:id/command/remove-participant", dataProviderName: "federation-learning-platform", stateField: "participantStatus", allowedStates: ["Suspended"] },
        inviteParticipant: { label: "Invite Participant", i18nKey: "resources.training_participant_eligibility.commands.inviteParticipant.label", route: "/training-participant-eligibility/:id/command/invite-participant", dataProviderName: "federation-learning-platform" },
        configureRuntimeDatasetBinding: { label: "Configure Runtime Dataset Binding", i18nKey: "resources.training_participant_eligibility.commands.configureRuntimeDatasetBinding.label", route: "/training-participant-eligibility/:id/command/configure-runtime-dataset-binding", dataProviderName: "federation-learning-platform" },
      },
      canDelete: false,
    },
  },
