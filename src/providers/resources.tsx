  ...
  },
  {
    ...
    meta: {
      ...
      commands: {
        ...
        confirmRuntimeInfrastructurePrepared: { label: "Confirm Runtime Infrastructure Prepared", i18nKey: "resources.runtime_agent_endpoint_catalog.commands.confirmRuntimeInfrastructurePrepared.label", route: "/runtime-agent-endpoint-catalog/:id/command/confirm-runtime-infrastructure-prepared", dataProviderName: "federation-learning-platform", stateField: "connectionStatus", allowedStates: ["Registered"] },
