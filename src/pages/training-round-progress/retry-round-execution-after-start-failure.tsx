      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <ResourceSelect
                  ...
                  meta={{
                    idField: "trainingJobId",
                    label: t("resources.training_round_progress.commands.retryRoundExecutionAfterStartFailure.fields.trainingJobId.label", "Training Participant Eligibility"),
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.training_round_progress.commands.retryRoundExecutionAfterStartFailure.fields.baseModelVersionId.label", "Base Model Version Id")}</FormLabel>
                <FormControl>
                  <Input
                    {...field}
                    value={field.value || ""}
