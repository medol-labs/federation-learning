...
export const RuntimeAgentEndpointCatalogRecordRuntimeConnectionEstablished = () => {
  ...
  return (
    <CreateView>
      <CreateViewHeader title={t("resources.runtime_agent_endpoint_catalog.commands.recordRuntimeConnectionEstablished.label", "Record Runtime Connection Established")} />
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit, (errors) => console.error("RecordRuntimeConnectionEstablished validation failed", errors))} className="space-y-8">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.runtime_agent_endpoint_catalog.commands.recordRuntimeConnectionEstablished.fields.runtimeAgentId.label", "Runtime Agent Id")}</FormLabel>
                <ResourceSelect
                  withFormControl
                  resource="runtime_agent_endpoint_catalog"
                  dataProviderName="federation-learning-platform"
                  ...
                  meta={{
                    idField: "runtimeAgentId",
                    label: t("resources.runtime_agent_endpoint_catalog.commands.recordRuntimeConnectionEstablished.fields.runtimeAgentId.label", "Runtime Agent Endpoint Catalog"),
                    aggregateRoute: "runtimeinfrastructure",
                    queryRoute: "runtimeagentendpointcatalog",
                  }}
                />
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.runtime_agent_endpoint_catalog.commands.recordRuntimeConnectionEstablished.fields.runtimeAgentEndpoint.label", "Runtime Agent Endpoint")}</FormLabel>
                <FormControl>
                  <Input
                    {...field}
                    value={field.value || ""}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.runtime_agent_endpoint_catalog.commands.recordRuntimeConnectionEstablished.fields.endpointScope.label", "Endpoint Scope")}</FormLabel>
                <ResourceSelect
                  withFormControl
                  resource="dictionary_value_catalog"
                  dataProviderName="federation-learning-support"
                  ...
                  meta={{
                    idField: "dictionaryValueId",
                    label: t("resources.runtime_agent_endpoint_catalog.commands.recordRuntimeConnectionEstablished.fields.endpointScope.label", "Dictionary Value Catalog"),
                    aggregateRoute: "dictionaryvalue",
                    queryRoute: "dictionaryvaluecatalog",
                    queryFields: ["dictionaryCode","active","state"],
                  }}
