...
export const TrainingParticipantEligibilityInviteParticipant = () => {
  ...
  return (
    <CreateView>
      <CreateViewHeader title={t("resources.training_participant_eligibility.commands.inviteParticipant.label", "Invite Participant")} />
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.training_participant_eligibility.commands.inviteParticipant.fields.organizationId.label", "Organization Id")}</FormLabel>
                <ResourceSelect
                  withFormControl
                  ...
                  placeholder={t("resources.training_participant_eligibility.commands.inviteParticipant.fields.organizationId.placeholder", "Select Organization Id")}
                  meta={{
                    idField: "organizationId",
                    label: t("resources.training_participant_eligibility.commands.inviteParticipant.fields.organizationId.label", "Organization Directory"),
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.training_participant_eligibility.commands.inviteParticipant.fields.invitationNote.label", "Invitation Note")}</FormLabel>
                <FormControl>
                  <Input
                    {...field}
                    value={field.value || ""}
