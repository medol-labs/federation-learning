        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">{formatValue(record?.heartbeatMissingBeyondThreshold, t)}</p>
            </div>
            <Separator />
            <div>
              ...
              <p className="text-sm text-muted-foreground">{formatValue(record?.heartbeatObservedAfterOffline, t)}</p>
            </div>
            <Separator />
            <div>
              ...
              <p className="text-sm text-muted-foreground">{formatValue(record?.resourcePressureDetected, t)}</p>
            </div>
            <Separator />
            <div>
