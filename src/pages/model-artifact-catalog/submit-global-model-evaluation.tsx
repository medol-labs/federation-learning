...
export const ModelArtifactCatalogSubmitGlobalModelEvaluation = () => {
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.model_artifact_catalog.commands.submitGlobalModelEvaluation.fields.trainingRunConfigurationId.label", "Training Run Configuration Id")}</FormLabel>
                <ResourceSelect
                  withFormControl
                  ...
                  placeholder={t("resources.model_artifact_catalog.commands.submitGlobalModelEvaluation.fields.trainingRunConfigurationId.placeholder", "Select Training Run Configuration Id")}
                  meta={{
                    idField: "trainingRunConfigurationId",
                    label: t("resources.model_artifact_catalog.commands.submitGlobalModelEvaluation.fields.trainingRunConfigurationId.label", "Training Run Configuration Catalog"),
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.model_artifact_catalog.commands.submitGlobalModelEvaluation.fields.featureSchemaId.label", "Feature Schema Id")}</FormLabel>
                <ResourceSelect
                  withFormControl
                  ...
                  value={field.value || ""}
                  onValueChange={field.onChange}
                  placeholder={t("resources.model_artifact_catalog.commands.submitGlobalModelEvaluation.fields.featureSchemaId.placeholder", "Select Feature Schema Id")}
                  meta={{
                    idField: "featureSchemaId",
                    label: t("resources.model_artifact_catalog.commands.submitGlobalModelEvaluation.fields.featureSchemaId.label", "Feature Schema Catalog"),
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.model_artifact_catalog.commands.submitGlobalModelEvaluation.fields.roundId.label", "Round Id")}</FormLabel>
                <FormControl>
                  <Input
                    {...field}
                    value={field.value || ""}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.model_artifact_catalog.commands.submitGlobalModelEvaluation.fields.aggregatedModelVersionId.label", "Aggregated Model Version Id")}</FormLabel>
                <FormControl>
                  <Input
                    {...field}
                    value={field.value || ""}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.model_artifact_catalog.commands.submitGlobalModelEvaluation.fields.modelFormat.label", "Model Format")}</FormLabel>
                <FormControl>
                  <Input
                    {...field}
                    value={field.value || ""}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.model_artifact_catalog.commands.submitGlobalModelEvaluation.fields.modelHash.label", "Model Hash")}</FormLabel>
                <FormControl>
                  <Input
                    {...field}
                    value={field.value || ""}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.model_artifact_catalog.commands.submitGlobalModelEvaluation.fields.globalAccuracy.label", "Global Accuracy")}</FormLabel>
                <FormControl>
                  <Input
                    {...field}
                    value={field.value || ""}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("resources.model_artifact_catalog.commands.submitGlobalModelEvaluation.fields.globalFairnessScore.label", "Global Fairness Score")}</FormLabel>
                <FormControl>
                  <Input
                    {...field}
                    value={field.value || ""}
