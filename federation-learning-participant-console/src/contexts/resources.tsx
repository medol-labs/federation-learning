...
export const backendModules = [
  ...
  },
  {
    ...
    resources: ["agent-dataset-access-validation-catalog","agent-feature-schema-catalog","agent-organization-directory","agent-runtime-identity-catalog","agent-runtime-infrastructure-connection-catalog","agent-runtime-node-inventory-catalog","agent-runtime-node-resource-latest","agent-runtime-telemetry-latest","dataset-capability","dataset-readiness","permission-catalog","role-catalog","role-permission-grant-catalog","round-execution-catalog","runtime-agent-lifecycle-catalog","runtime-dataset-binding-catalog","service-account-api-token-catalog","user-account-catalog","user-role-assignment-catalog"],
  },
];
