...
export const DatasetCapabilityConfigureRuntimeDatasetBinding = () => {
  ...
  async function onSubmit(values: ConfigureRuntimeDatasetBindingCommandInput) {
    const result = await runFormBehavior<ConfigureRuntimeDatasetBindingCommandInput>(
      frontendComposition,
      "behavior:dataset-capability:configureRuntimeDatasetBinding",
      {
      ...defaultValues,
      ...values,
      } as ConfigureRuntimeDatasetBindingCommandInput,
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <ResourceSelect
                  ...
                  meta={{
                    idField: "runtimeId",
                    label: t("resources.dataset_capability.commands.configureRuntimeDatasetBinding.fields.runtimeId.label", "Agent Runtime Identity Catalog"),
              ...
              <FormItem>
                ...
                <ResourceSelect
                  ...
                  meta={{
                    ...
                    label: t("resources.dataset_capability.commands.configureRuntimeDatasetBinding.fields.dataFormat.label", "Agent Dictionary Value Catalog"),
