...
import { LoadRuntimeAgentBootstrapConfigurationCommandSchema, type LoadRuntimeAgentBootstrapConfigurationCommandInput } from "@/contexts/domain/schemas";
...
export const RuntimeAgentLifecycleCatalogLoadRuntimeAgentBootstrapConfiguration = () => {
  ...
  async function onSubmit(values: LoadRuntimeAgentBootstrapConfigurationCommandInput) {
    const result = await runFormBehavior<LoadRuntimeAgentBootstrapConfigurationCommandInput>(
      frontendComposition,
      "behavior:runtime-agent-lifecycle-catalog:loadRuntimeAgentBootstrapConfiguration",
      {
      ...defaultValues,
      ...values,
      } as LoadRuntimeAgentBootstrapConfigurationCommandInput,
