...
import { ApproveDatasetForTrainingCommandSchema, type ApproveDatasetForTrainingCommandInput } from "@/contexts/domain/schemas";

export const DatasetCapabilityApproveDatasetForTraining = () => {
  ...
  async function onSubmit(values: ApproveDatasetForTrainingCommandInput) {
    const result = await runFormBehavior<ApproveDatasetForTrainingCommandInput>(
      frontendComposition,
      "behavior:dataset-capability:approveDatasetForTraining",
      {
      ...defaultValues,
      ...values,
      } as ApproveDatasetForTrainingCommandInput,
  ...
  return (
    <CreateView>
      <CreateViewHeader title={t("resources.dataset_capability.commands.approveDatasetForTraining.label", "Approve Dataset For Training")} />
      <Form {...form}>
