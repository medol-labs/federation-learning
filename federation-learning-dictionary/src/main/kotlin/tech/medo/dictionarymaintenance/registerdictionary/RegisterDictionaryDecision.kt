...
class RegisterDictionaryDecision {
    fun decide(command: RegisterDictionaryCommand, dictionaryCodeReservation: DictionaryCodeReservationState): List<Any> {
        ...
        return listOf(
            DictionaryCodeReservedEvent(dictionaryId = command.dictionaryId, dictionaryCode = command.dictionaryCode, normalizedName = command.dictionaryCode.toString().trim().lowercase()),
